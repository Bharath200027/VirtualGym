...
{
    public static bool caliberationDone = false;
...
//			}
    ...
    protected virtual void CalibrateUser(Int64 userId, int bodyIndex)
    {
		...
		{
			if(CheckForCalibrationPose(userId, bodyIndex, playerCalibrationPose) /*&& calibrationStarted*/)
			{
                if (calibrationStarted)
                {
                    caliberationDone = true;
                }
...
//						else
	...
	protected virtual bool CheckForCalibrationPose(Int64 UserId, int bodyIndex, KinectGestures.Gestures calibrationGesture)
	{
        ...
        if(calibrationGesture == KinectGestures.Gestures.Tpose)
        {
            calibrationStarted = true;
            //Debug.Log(caliberationDone.ToString());
        }
